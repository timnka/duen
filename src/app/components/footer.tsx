    ...
    return (
        <div className="min-h-full w-full bg-duen-purple-500 text-duen-gold-200 text-sm md:text-base">
            <div className="flex flex-col items-center justify-center py-8">
                ...
                <Link href='https://tinyurl.com/duen-interest-form' target="_blank" className='bg-purple text-white px-8 py-2 rounded-lg border-2 border-purple transition duration-300 hover:border-duen-purple-500 hover:cursor-pointer hover:text-duen-gold-300'>
                ...
                <div className="text-lg flex justify-center items-center">
                    ...
                    <div className="px-5 flex">
                        {/* Instagram */}
                        <Link href="https://www.instagram.com/duen_ucd/" target="_blank" className="px-5">
