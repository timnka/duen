        ...
        <div className="min-h-full w-full bg-duen-purple-500 text-duen-gold-200">
            <div className="flex flex-col items-center justify-center text-base py-8">
                ...
                <div className="text-lg flex justify-center items-center">
                    ...
                    <div className="px-5 text-sm flex">
                        {/* Instagram */}
                        <Link href="https://www.instagram.com/duen_ucd/" target="_blank" className="px-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="gray" className="hover:fill-lavender hover:cursor-pointer hover:scale-110 transition ease-in" viewBox="0 0 16 16">
