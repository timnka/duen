      ...
      <div className="w-72 min-h-min flex flex-col items-center px-5">
        ...
        <div className="py-3 w-full">
          <div className="flex justify-between items-start">
            <p className="font-mono text-xs tracking-widest text-duen-gold-300 uppercase">{name}</p>
            <Link href={linkedin} target="_blank">
              <svg
                ...
                height="18"
                fill="currentColor"
                className="text-duen-gold-300/50 hover:text-duen-gold-300 hover:cursor-pointer hover:scale-110 transition ease-in shrink-0 ml-2"
                viewBox="0 0 23 23"
              >
